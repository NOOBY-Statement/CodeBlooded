...
import profileImg from "../assets/legaspi.png";
import { RiJavascriptFill } from "react-icons/ri";
import { DiHtml5 } from "react-icons/di";
import { Link } from 'react-router-dom';

const skillIcons = {
 "MySQL": <FaDatabase className="inline mr-1" />,
...
const members = [
  {
    name: "Shaira Mae A. Legaspi",
    role: "UI/UX Designer, Frontend Developer",
    skills: ["Database Management", "Python", "Java", "PHP", "React", "HTML", "CSS","Javascript", "C++"],
    socials: {
      github: "https://github.com/shaira-maeee",
      facebook: "https://www.facebook.com/shyyyyra.mae",
    },
    image: profileImg
